...
tags: [词法,转载]
categories: 重学前端系列笔记
cover: "https://raw.githubusercontent.com/CasualMing/BlogPhoto/master/f34d8307bb56.png"
---
...
此外，JavaScript 支持所有的 Unicode 中的空格分类下的空格，我们可以看下表：<br />![](https://raw.githubusercontent.com/CasualMing/BlogPhoto/master/f34d8307bb56.png)<br />很多公司的编码规范要求 JavaScript 源代码控制在 ASCII 范围内，那么，就只有`<TAB>` `<VT>` `<FF>` `<SP>` `<NBSP>`五种空白可用了。
